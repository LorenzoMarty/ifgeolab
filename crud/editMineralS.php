...
<body>
    ...
    <div class="container">
        ...
        <hr>
        <form enctype="multipart/form-data" method="post" action="processaMineralS.php" class="col  s12 m6">
            ...
            <div class="row">
                ...
                <div class="input-field col s6">
                    <select name="cat" class="validate">
                        ...
                        require_once "../conecta.php";
                        $conexao = conectar();
                        $x = "SELECT * FROM catmineral";
                        $result = mysqli_query($conexao, $x);
                        while ($dado = mysqli_fetch_assoc($result)) {
                            ?>
                            <option value="<?php echo $dado['idcat']; ?>">
                                <?php echo $dado['nome']; ?>
                            </option>
                        <?php } ?>
                    </select>
            ...
            <div class="row">
                ...
                <div class="input-field col s12">
                    <button class="waves-effect waves-light btn green" type="submit" name="editar">Editar</button>
                </div>
            </div>
        </form>
    </div>
