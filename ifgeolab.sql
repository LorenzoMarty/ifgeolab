...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 20/03/2024 às 17:41
...
--
-- Despejando dados para a tabela `sugerirmineral`
--

INSERT INTO `sugerirmineral` (`idmineral`, `nome`, `descricao`, `img`, `idcat`) VALUES
(1, 'Ferro', 'ferro teste', 'ferro.jpg', 1);

-- --------------------------------------------------------

--
-- Estrutura para tabela `sugerirrocha`
--

DROP TABLE IF EXISTS `sugerirrocha`;
CREATE TABLE IF NOT EXISTS `sugerirrocha` (
  `idrocha` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `descricao` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `img` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
(4, 'Lorenzo', '05500840029@gmail.com', '$2y$10$vV.mPuRk1dx3eVOh7xSp1O5ZdEmxlHb.Iq.TyG2V8cOt5TMF0.wHO', '55996448396', 1, 'user-5jpeg', 2022310934),
(5, 'Lorenzo', 'lorenzodreis@gmail.com', '$2y$10$O1kWPlRgkuuxL3cSLxMVAeall0..MYqNihrGknT/EZscc32WX0luG', '55996448396', 2, 'user-5.png', 2022310934),
(8, 'Teste', '010101@gmail.com', '$2y$10$ekaXbY2iLDpQe2XToo8Vy.dLKH8D7dqu0l6hFW8kyjm2cEQrRVZ5W', '13113123', 1, 'user-8.jpg', 1312323123);
