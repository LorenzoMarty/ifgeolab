  ...
  <header>
    ...
    <nav class="nav_color" role="navigation">
      <div class="nav-wrapper">
        ...
        <li><a class="white-text" href="crud/Sugestao.php">Sugestões</a></li>
        <li><a class="white-text" href="crud/Amostra.php">Amostra</a></li>
          <li style="margin-right: 10px;"><a class="white-text" href="crud/editUser.php?idusuario=".<?php $_COOKIE['acesso']['id']; ?>><?php echo $dados['nome']; ?></a></li>
    ...
    <ul class="sidenav white-text #212121 grey darken-4 " style="width: 350px;" id="telefone-nav">
      ...
      <li><a class="white-text" href="cadAmostra.php">Cadastrar Amostra</a></li>
        <li style="margin-right: 10px;"><a class="white-text" href="tela_user.php?idusuario=".<?php $_COOKIE['acesso']['id']; ?>><?php echo $dados['nome']; ?></a></li>
        <li style="margin-right: 10px;"><img src="img/usuarios/<?= $img; ?>" class="perfil materialboxed "></li>
      </ul>
      <hr>
      <div class="row">
